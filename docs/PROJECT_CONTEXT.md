...
JVM contract suite запускается этой командой. Воспроизводимый scoped device gate, результат и landscape-кадры renderer regression #13 описаны в [`docs/evidence/issue-13/README.md`](evidence/issue-13/README.md). Retained-modal и bottom-sheet gate #14, Maestro flow и пять portrait-кадров описаны в [`docs/evidence/issue-14/README.md`](evidence/issue-14/README.md).
